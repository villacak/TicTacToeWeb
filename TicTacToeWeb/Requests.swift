...
class Requests: NSObject {
    ...
    //
    // For requests using Get
    //
//    func requestSearch(urlToCall urlToCall: String, method: String, controller: UIViewController, completionHandler:(result: NSDictionary?, error: String?) -> Void) -> NSURLSessionDataTask  {
